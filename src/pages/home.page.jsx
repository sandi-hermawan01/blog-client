      ...
      <section className="h-cover flex justify-center gap-10">
        ...
        <div className="flex min-w-[30%] lg:min-w-[300px] max-w-min border-l border-r border-grey px-3 pt-3 max-md:hidden">
          <div className="flex flex-col gap-5 w-80">
            <div className="mb-4 border-grey text-center max-md:hidden">
              <h1 className="font-medium text-xl mb-4 ">Advertisement</h1>
              <div className="border border-grey rounded-lg h-36 px-5"></div>
            </div>
            <div>
              <h1 className="font-medium text-xl mb-4">
